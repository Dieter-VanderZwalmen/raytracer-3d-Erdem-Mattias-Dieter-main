...
namespace
{
    class CartoonRenderer : public raytracer::renderers::_private_::RendererBaseCartoonImplementation
    {
    public:
        CartoonRenderer(unsigned horizontal_size, unsigned vertical_size, unsigned shade_count, raytracer::Sampler sampler, RayTracer ray_tracer, tasks::TaskScheduler scheduler)
            : RendererBaseCartoonImplementation(horizontal_size, vertical_size, shade_count, sampler, ray_tracer, scheduler)
        {
...
Renderer raytracer::renderers::cartoon(unsigned horizontal_size, unsigned vertical_size, unsigned shade_count, raytracer::Sampler sampler, RayTracer ray_tracer, tasks::TaskScheduler scheduler)
{
    return Renderer(std::make_shared<CartoonRenderer>(horizontal_size, vertical_size, shade_count, sampler, ray_tracer, scheduler));
}
