...
int main(int argc, char** argv)
{
    ...
    // const std::string path = R"(C:\Users\mawa2\OneDrive\Documenten\School\3de jaar\1ste semester\3D grapic\raytracer-3d-Erdem-Mattias-Dieter\shaiScripts\MeshOptimizerMattias\mesh.chai)";
    const std::string path = R"(C:/Users/erdem/Desktop/School/TI (2022-2023)/Semester 1/3DCG/DebugTest.chai)";
    // const std::string path = R"(C:/Users/diete/Desktop/Semester7/Distributed applications/project/scripts-3D/meshreader.chai)";
    render_script(path);
#endif
}   
